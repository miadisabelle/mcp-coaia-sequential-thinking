...
class TestThoughtStage(unittest.TestCase):
    ...
    def test_from_string_valid(self):
        ...
        self.assertEqual(ThoughtStage.from_string("Structural Tension"), ThoughtStage.STRUCTURAL_TENSION)
        self.assertEqual(ThoughtStage.from_string("Action Step"), ThoughtStage.ACTION_STEP)
        self.assertEqual(ThoughtStage.from_string("Advancement"), ThoughtStage.ADVANCEMENT)
        self.assertEqual(ThoughtStage.from_string("Bias Mitigation"), ThoughtStage.BIAS_MITIGATION)
