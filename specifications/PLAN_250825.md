...
*   **Action:** Create the file `mcp-coaia-twoeyesseen-holistic-thinking/mcp_coaia_twoeyesseen_holistic_thinking/colint_integration.py`.
...
*   **File:** `mcp-coaia-twoeyesseen-holistic-thinking/mcp_coaia_twoeyesseen_holistic_thinking/models.py`
...
*   **File:** `mcp-coaia-twoeyesseen-holistic-thinking/mcp_coaia_twoeyesseen_holistic_thinking/server.py`
